        ...
        <li v-for="(item,index) in addressData" :key="index" :id="item.contactsCode">
          ...
          <p>
            ...
            <label>
              ...
              <router-link
                :to="{path:'/addressEdit',query:{addressCode:item.contactsCode,redirect: $router.currentRoute.fullPath}}"
              >
                <s>编辑</s>
              </router-link>
            </label>
...
<script>
import { getAddressList, defaultAddress, delAddress } from "../../api/api";
